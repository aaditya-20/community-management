    ...
    <div className="grid grid-cols-[auto,auto]   bg-[#171C23] grid-rows-[71px,auto] h-[1000px] w-[1450px]    md:grid-cols-[auto,1fr]">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex mx-[20px] mb-[30px] w-[auto] bg-[#171C23] ">
          <p className="text-[#A6A6A6] font-[400] text-[16px]">
            check who is ahead of evryone
          </p>
          <button className="absolute right-[20px] flex items-center justify-evenly mb-[10px] border-[1px] border-[#757575]  text-[#757575] rounded-[8px] w-[109px] h-[33px]">
            Last Week <BsChevronDown color="#757575" size={15} className="" />
          </button>
        </div>
        <div>{ele}</div>
