 ...
 const [ShowAuthenticationPage,setShowAuthenticationPage] = useState(false);
  async function LinkWallet() {
      ...
      wholeData.forEach((val)=>{
        ...
        if(val.missions){
            ...
            val.missions.forEach((val2:any)=>{
              ...
              if(val2.mission_id!=null&&missionDetails!=null&&missionDetails.mission_id==val2.mission_id){
    ...
    if(community_id!==''){
        ...
        alert('community id cant be fetched try refereshing or the mission  is not listed inside any of the community');
    }
    return;
  ...
  if(ShowAuthenticationPage){
    return (
        <div className="h-[100vh] w-[100vw] bg-[black]">
             <MissionUserAuthCard communityId = {community_id} missionDetails={missionDetails}/>
        </div>
