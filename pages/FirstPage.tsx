    ...
    <>
      ...
      <div className="min-h-screen  relative overflow-x-hidden scrollbar-hide">
        ...
        <div className="w-full flex justify-center">
          <div className="relative top-[116px] w-[811px] text-center font-semibold text-[72px] text-[#EAE9EB]">
            <h1>Scale web3 communities 10X faster</h1>
          </div>
        </div>

        <div className="w-full flex justify-center">
          <div className="relative top-[128px] text-center font-normal text-[#A9A6B7] text-3xl w-[597px] h-auto">
