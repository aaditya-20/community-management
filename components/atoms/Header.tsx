...
const Header = () => {
  return (
    <div className="relative box-border box-sizing border-box w-[1600px] h-[80px] left-[0px] top-0 bg-gradient-to-b from-gray-900 to-gray-800  border-b-1 border-[#171C23]">
